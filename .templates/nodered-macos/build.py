...
def main():
  ...
  def selectNodeRedAddons():
    global needsRender
    global hasRebuiltAddons
    dockerCommandsFilePath = "./.templates/nodered-macos/addons.py"
...
global currentServiceName # Name of the current service
if currentServiceName == 'nodered-macos':
  main()
else:
  print("Error. '{}' Tried to run 'nodered-macos' config".format(currentServiceName))
